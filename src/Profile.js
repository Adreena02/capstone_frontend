...
function Profile({showUserVillagers, dreamVillagers, removeNeighbor, handleDeleteClick, removeDream}) {
    return(
        <div>
            ...
            <DreamVillagerContainer dreamVillagers={dreamVillagers} removeDream={removeDream}/>
        </div>
    )
}
